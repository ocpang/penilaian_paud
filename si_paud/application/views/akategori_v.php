				...
				?>
                    ...
                    <tr>
                        ...
                        <td><?PHP echo $row->namakategori; ?>
                            <input type="hidden" id="idkategorinilai_<?php echo $row->idkategorinilai; ?>" value="<?php echo $row->idkategorinilai; ?>" />
                            <input type="hidden" id="kategori_<?php echo $row->idkategorinilai; ?>" value="<?php echo $row->namakategori; ?>" />
                        </td>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm edit" title="Ubah" data-toggle="modal" data-target="#modal_kategori" id="edit_<?PHP echo $row->idkategorinilai; ?>">
                                <i class="glyphicon glyphicon-edit"></i> Ubah
                            </button>
                            <button class="btn btn-danger btn-sm delete" title="Hapus" data-toggle="modal" data-target="#modal_confirm" id="delete_<?PHP echo $row->idkategorinilai; ?>" >
            ...
            <div class="modal-body">
            	<form method="post" id="form_kategori">
                	<div class="form-group">
                        ...
                        <input type="hidden" name="idkategorinilai_tmp" id="idkategorinilai_tmp" />
                    </div>
                </form>
            </div>
	...
	$(document).ready(function(){
		...
		$("#delete").click(function() {
			$.post("<?PHP echo base_url(); ?>akategori/delete", { 
				idkategorinilai: $("#idkategorinilai_tmp").val() }, 
				function() {
